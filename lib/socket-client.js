...
export const initSocket = () => {
  ...
  try {
    // Always use window.location.origin so socket connects to whatever port the app is running on
    const socketUrl = typeof window !== 'undefined' ? window.location.origin : (process.env.NEXT_PUBLIC_BASE_URL || 'http://localhost:3000');
