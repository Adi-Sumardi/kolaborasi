...
export function calculateKpiHasilKinerja({
  ...
  // Use sp2dkPenaltyTotal if provided, otherwise fall back to count * 5
  const sp2dkDeduction = sp2dkPenaltyTotal !== null ? sp2dkPenaltyTotal : (sp2dkCount * 5);
  const deductions = (warningLetterCount * 5) + sp2dkDeduction;
